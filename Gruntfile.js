/*!
 * Semantic Strap's Gruntfile (based on Bootstrap)
 * http://websemantics.github.io/semantic-strap
  ...
  grunt.initConfig({
    ...
    babel: {
      ...
      dist: {
        ...
        files: {
          '<%= concat.semantic_strap.dest %>' : '<%= concat.semantic_strap.dest %>'
        }
      }
    },
    ...
    stamp: {
      ...
      semantic_strap: {
        files: {
          src: '<%= concat.semantic_strap.dest %>'
        }
      }
    },
    ...
    watch: {
      src: {
        files: '<%= concat.semantic_strap.src %>',
        tasks: ['babel:dev']
      },
      sass: {
        files: 'scss/**/*.scss',
    ...
    buildcontrol: {
      ...
      pages: {
        options: {
          remote: 'git@github.com:websemantics/semantic-strap.git',
          branch: 'gh-pages'
        }
      }
    },
